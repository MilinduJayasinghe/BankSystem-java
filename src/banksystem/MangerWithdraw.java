 ...
 */
public class MangerWithdraw extends javax.swing.JFrame {

    /**
     * Creates new form MangerWithdraw
     */
    public MangerWithdraw() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        JOptionPane.showMessageDialog(rootPane, "Withdraw Money : "+value1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MangerWithdraw.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MangerWithdraw().setVisible(true);
            }
        });
    }
